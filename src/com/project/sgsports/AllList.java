...
public class AllList extends MainActivity {
		...
		if (c.moveToFirst()) {
			do {
				...
				if (contact[1].equals("Basketball")
						|| contact[1].equals("Football")
						|| contact[1].equals("Hockey")
						|| contact[1].equals("Volleyball")
						|| contact[1].equals("Tennis")
						|| contact[1].equals("Badminton")) {
					games.add(contact);
				}
			} while (c.moveToNext());
		}
	...
	public void viewSpecificGame(View view) {
		Intent newIntent;
		newIntent = new Intent(this, GameView.class);
