...
public class HockeyList extends MainActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hockeylist);

		database = new GameDB(this);

		ArrayList<String[]> games = GetSquashArray();
	...
	public ArrayList<String[]> GetSquashArray() {
		// --get soccer contacts---
		database.open();
