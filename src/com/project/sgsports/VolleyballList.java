...
public class VolleyballList extends MainActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<String[]> games = GetVolleyballArray();
	...
	public ArrayList<String[]> GetVolleyballArray() {
		// --get soccer contacts---
		database.open();
		...
		if (c.moveToFirst()) {
			do {
				...
				if (contact[1].equals("Volleyball")) {
					games.add(contact);
				}
			} while (c.moveToNext());
		}
