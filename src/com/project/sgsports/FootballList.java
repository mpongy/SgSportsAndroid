...
public class FootballList extends MainActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.footballlist);

		database = new GameDB(this);

		ArrayList<String[]> games = GetFootballArray();
	...
	public ArrayList<String[]> GetFootballArray() {
		// --get soccer contacts---
		database.open();
