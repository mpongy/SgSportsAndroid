...
public class BadmintonList extends MainActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.badmintonlist);

		database = new GameDB(this);

		ArrayList<String[]> games = GetBadmintonArray();
	...
	public ArrayList<String[]> GetBadmintonArray() {
		// --get soccer contacts---
		database.open();
